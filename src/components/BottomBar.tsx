...
const BottomBar = () => {
  ...
  return (
    <div className="fixed left-1/2 bottom-8 z-50 -translate-x-1/2">
      <div className="flex items-center gap-3 bg-white/80 dark:bg-zinc-900/80 rounded-full shadow-lg px-5 py-3 backdrop-blur-md border border-zinc-200 dark:border-zinc-800">
        <a href="#home" aria-label="Home">
          <Home className="w-5 h-5" />
        </a>
        <span className="h-5 w-px bg-zinc-300 dark:bg-zinc-700 mx-1" />
